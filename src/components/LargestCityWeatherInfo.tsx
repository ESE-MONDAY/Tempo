...
const LargestCityWeatherInfo: React.FC<CityWeatherInfoProps> = ({ cityInfo }) => {
  ...
  const handleDeleteCity =(value: string) => {
    dispatch(deleteCityWeatherData(value) as any)
  }
  ...
  return (
    <div className='rounded-lg bg-gray-700 shadow-md p-4 min-w-[200px] mt-8 text-gray-100 '>
      ...
      <button className='text-base text-red-500 font-medium'  onClick={() => handleDeleteCity(cityInfo.city)}>Delete</button>
...
export default LargestCityWeatherInfo;
